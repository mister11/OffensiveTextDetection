...
public interface IHtmlParser {
	 ...
	 *
	 * @param html HTML from which posts are extracted
	 * @param w    {@link FileWriter} object used to write posts to file.
	 ...
	 *
	 * @param html    HTML from which links are extracted.
	 * @param links   {@link Queue} of URLs which have to be processed
	 * @param visited {@link HashSet} which contains all URLs which are processed
	 */
